...
# Check and set fan speed based on temperature
if [[ $TEMP -ge $TEMP3 ]]; then
  ...
  # Set fans to manual mode and apply speed 3
  ...
  # Set fans to manual mode and apply speed 2
  ipmitool -I lanplus -H $IPMIHOST -U $IPMIUSER -P $IPMIPW -y $IPMIEK raw 0x30 0x30 0x01 0x00
  ...
  # Set fans to manual mode and apply speed 1
  ipmitool -I lanplus -H $IPMIHOST -U $IPMIUSER -P $IPMIPW -y $IPMIEK raw 0x30 0x30 0x01 0x00
